...
!                   FOR Z0_POLY ELEMENTS THE OUTWARD POINTING FACE IS ALWAYS F2 (i.e. nodes 6,2,3,7)
                    ...
                    do ipquad=1,iGPquad
                        ...
                        pNNquad(ipquad,1) = 1/four*(1-xi1quad)*(1-xi2quad)
                        ...
                        do ni=1,4
                            ...
                            if (kblock==1) then
                                write(*,*) ndofel
                                write(*,*) dofniT
                                write(*,*) pWTquad*ABS(detJquad(ipquad))*pNNQuad(ipQuad,ni)*(-1.0d0)*1.0E-4
                            end if
                             RHS(kblock,dofniT) = RHS(kblock,dofniT) - pWTquad*ABS(detJquad(ipquad))*pNNQuad(ipQuad,ni)*(-1.0d0)*1.0E-3  
